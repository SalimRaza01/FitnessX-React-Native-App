...
export default function YourGoal2(props) {
  ...
  return (
    <View style={{
      ...
      <ImageBackground source={require('../assets/box.png')} resizeMode="cover" style={styles.image}>
        <Image style={styles.logo} source={require('../assets/Goal3.png')} />
        <Text style={styles.heading2}>Lose a Fat</Text>
        <Text style={styles.para3}>________</Text>
        <Text style={styles.para2}>I have over 20 lbs to lose. I want to drop all this fat and gain muscle mass</Text>


      </ImageBackground>
      < TouchableOpacity style={styles.mybtn} onPress={() => props.navigation.navigate('RegisterSuccess')}>
